...
class BughouseStudyTool {
    ...
    selectPiece(boardId, squareCoord, piece) {
        ...
        this.renderBoards();
        const checkPrefix = board.check ? `⚠️ CHECK on Board ${boardId.toUpperCase()}! ` : '';
        this.updateStatus(`${checkPrefix}Selected ${piece.color} ${piece.type} at ${this.coordToNotation(squareCoord, boardId)}`);
    }
